...
public class CasoDeTesteResource {
    ...
    public Response inserirCasoDeTeste(CasoDeTeste caso) {
        ...
        try {
            ...
            return Response.Ok("Caso De Teste inserido com sucesso id="+caso.getId());
        } catch (Exception ex) {
    ...
    public Response updateCasoDeTeste(CasoDeTeste caso) {
        ...
        try {
            ...
            return Response.Ok("Casos De Teste Atualizado com Sucesso");
        } catch (Exception ex) {
            System.out.println("Falhou");
            return Response.Error(ex.getMessage());
        }
    ...
    public Response deleteCasoDeTeste(CasoDeTeste caso) {
        ...
        try {
            ...
            return Response.Ok("Casos De Teste Deletado com Sucesso");
        } catch (Exception ex) {
            System.out.println("Falhou");
            return Response.Error(ex.getMessage());
        }
